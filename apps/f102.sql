...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'FARMS')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_102')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'958027232080989393D4913C03A0D83CA7D452E3921FEFA8FBA996DFAD330801'
...
,p_authentication_id=>wwv_flow_api.id(5289435990519756)
,p_application_tab_set=>0
,p_logo_image=>'TEXT:FARMS'
...
,p_last_upd_yyyymmddhh24miss=>'20171106013453'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(5241327983298169)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5251706185298223)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5284865592246359)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5240758928298168)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5240879401298168)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5240969586298169)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5241020251298169)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5241166662298169)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'modern'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5241291195298169)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(5249751022298209)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(5250995676298219)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5241464263298176)
,p_theme_id=>51
,p_name=>'Dialog'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5241512489298181)
,p_theme_id=>51
,p_name=>'Page'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5242055430298183)
,p_theme_id=>51
,p_name=>'Popup'
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(5244461464298192)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(5248676078298195)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5242171947298183)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5242227315298185)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5242375048298185)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5242444147298185)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5242569278298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5242609912298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5242715920298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5242815399298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5242999821298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5243031427298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5243180372298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5243252446298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5243320262298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5243461050298186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5243672083298188)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5243739274298190)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5243888180298190)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5243920988298190)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5244078211298190)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5243502777298187)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(5244156738298191)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(5244222229298192)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(5244302068298192)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(5249039246298198)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(5248905035298196)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(5249506802298204)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(5241512489298181)
,p_default_dialog_template=>wwv_flow_api.id(5241464263298176)
,p_error_template=>wwv_flow_api.id(5241512489298181)
,p_printer_friendly_template=>wwv_flow_api.id(5241512489298181)
,p_login_template=>wwv_flow_api.id(5241512489298181)
,p_default_button_template=>wwv_flow_api.id(5248676078298195)
,p_default_region_template=>wwv_flow_api.id(5243252446298186)
,p_default_chart_template=>wwv_flow_api.id(5243252446298186)
,p_default_form_template=>wwv_flow_api.id(5243252446298186)
,p_default_reportr_template=>wwv_flow_api.id(5243461050298186)
,p_default_tabform_template=>wwv_flow_api.id(5243252446298186)
,p_default_wizard_template=>wwv_flow_api.id(5243252446298186)
,p_default_irr_template=>wwv_flow_api.id(5243252446298186)
,p_default_report_template=>wwv_flow_api.id(5243502777298187)
,p_default_label_template=>wwv_flow_api.id(5244222229298192)
,p_default_calendar_template=>wwv_flow_api.id(5248905035298196)
,p_default_list_template=>wwv_flow_api.id(5243888180298190)
,p_default_nav_list_template=>wwv_flow_api.id(5243739274298190)
,p_default_top_nav_list_temp=>wwv_flow_api.id(5243739274298190)
,p_default_side_nav_list_temp=>wwv_flow_api.id(5244078211298190)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(5242171947298183)
,p_default_dialogr_template=>wwv_flow_api.id(5243252446298186)
,p_default_option_label=>wwv_flow_api.id(5244222229298192)
,p_default_header_template=>wwv_flow_api.id(5242999821298186)
,p_default_footer_template=>wwv_flow_api.id(5242715920298186)
,p_default_required_label=>wwv_flow_api.id(5244302068298192)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(5249185511298199)
,p_theme_id=>51
,p_name=>'Blue'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(5249203502298199)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(5249350228298199)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(5249413614298199)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(5241664933298182)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(5244590451298193)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(5245075471298193)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5241719285298183)
,p_theme_id=>51
,p_name=>'OVERLAY'
,p_display_name=>'Overlay'
,p_display_sequence=>1
,p_page_template_id=>wwv_flow_api.id(5241512489298181)
,p_css_classes=>'overlay'
,p_group_id=>wwv_flow_api.id(5241664933298182)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5241886440298183)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5241911664298183)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5244666473298193)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
,p_display_name=>'Action'
,p_display_sequence=>100
,p_button_template_id=>wwv_flow_api.id(5244461464298192)
,p_css_classes=>'ui-icon-action'
,p_group_id=>wwv_flow_api.id(5244590451298193)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5244706280298193)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5244837397298193)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5244979560298193)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5245169788298193)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
...
,p_group_id=>wwv_flow_api.id(5245075471298193)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5245264245298193)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5245325400298193)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5245428809298194)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5245568300298194)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5245618458298194)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5245788300298194)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5245897089298194)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5245989676298194)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246048652298194)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246197438298194)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246247159298194)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246305623298194)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246452530298194)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246548420298194)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246696968298194)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246794617298194)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246889110298194)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5246930703298194)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247011252298194)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247119233298194)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247238136298194)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247361559298194)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247440698298194)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247526393298194)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247636808298194)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247702248298194)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
,p_display_name=>'Right'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247844709298195)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5247902391298195)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5248065817298195)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5248146651298195)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5248215457298195)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5248388190298195)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5248449322298195)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5248552915298195)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5248713811298195)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(5248676078298195)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(5248896526298195)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(5261860582051073)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(5249847284298210)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(5253153968312557)
,p_name=>'Open'
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(5289435990519756)
,p_name=>'Custom_auth'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(5249616172298208)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(5241327983298169)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(5244078211298190)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(5249616172298208)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5251215976298220)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5242999821298186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5251546323298220)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5242715920298186)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5251495700298220)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5251215976298220)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5251381284298220)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(5251609089298220)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(5251381284298220)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(5251609089298220)
,p_event_id=>wwv_flow_api.id(5251609089298220)
,p_event_result=>'TRUE'
...
,p_cache_mode=>'NOCACHE'
,p_last_updated_by=>'SILVER'
,p_last_upd_yyyymmddhh24miss=>'20171105003414'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5254189568353701)
,p_plug_name=>'List'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5243252446298186)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_plug_source=>'XXFARMS_API.PRINT_FARMS_LIST();'
...
,p_cache_mode=>'NOCACHE'
,p_last_updated_by=>'SILVER'
,p_last_upd_yyyymmddhh24miss=>'20171105003031'
);
end;
/
